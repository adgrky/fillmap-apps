  ...
  return (
    <div className="space-y-2">
      {Object.entries(byOperator).map(([operator, lines]) => (
        <div key={operator}>
          <p className="mb-1 text-[11px] text-text-dim">{operator}</p>
              ...
              {months.map(({ month, entries }) => (
                <div key={month}>
                  <div className="mb-1 flex items-baseline gap-2">
                    ...
                    <span className="text-xs text-text-dim">{entries.length}路線</span>
                  </div>
        ...
        {undated.length > 0 && (
          <section>
            <div className="mb-2 flex items-baseline gap-2">
              ...
              <span className="text-xs text-text-dim">{undated.length}路線</span>
            </div>
