...
if (isNativeApp()) {
  ...
  void initIap({
    productId: (import.meta.env.VITE_IAP_PRODUCT_ID as string) || "michimap.premium",
    storageKey: "michimap.v1",
    onUnlocked: () => window.dispatchEvent(new Event("michimap:premium-unlocked")),
  });
}
