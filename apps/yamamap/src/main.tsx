...
if (isNativeApp()) {
  ...
  void initIap({
    productId: (import.meta.env.VITE_IAP_PRODUCT_ID as string) || "yamamap.premium",
    storageKey: "yamamap.v1",
    onUnlocked: () => window.dispatchEvent(new Event("yamamap:premium-unlocked")),
  });
}
