// 称号一覧シート(SPEC §A1)。解除済み/未解除を一覧表示。
import { cityAchievements } from "../domain/achievementDefs";
          ...
          return (
            <div
              ...
              className={`flex items-center gap-4 rounded-xl px-4 py-3 ${
                isUnlocked ? "bg-[#1a2a1a]" : "bg-[#151a23] opacity-60"
              }`}
            >
              <span className="text-2xl w-8 text-center">{isUnlocked ? "🏆" : "🔒"}</span>
              <div className="flex-1 min-w-0">
                ...
                {isUnlocked && (
                  <div className="text-xs text-[#4a7a4a] mt-1">
