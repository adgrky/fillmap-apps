...
if (isNativeApp()) {
  ...
  void initIap({
    productId: (import.meta.env.VITE_IAP_PRODUCT_ID as string) || "citymap.premium",
    storageKey: "citymap.v1",
    onUnlocked: () => window.dispatchEvent(new Event("citymap:premium-unlocked")),
  });
}
